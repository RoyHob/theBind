    ...
    return Column(
      ...
      children: [
        SizedBox(
          ...
          child: Row(
            children: [
              const Text("MEET OUR TEAM", style: TextStyle(color: Colors.white, fontSize: 50, fontWeight: FontWeight.bold)),
            ],
          ),
        ),
        // const SizedBox(height: 200),
        const Expanded(child: PhysioListInformation()),
      ],
    );
  }
}
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Column(
                    children: [
                      Text("professeur comfirme en phystioterapei elb alhgapohrgapoiehgoaigheoairgklahgoaihgoaihgaoihgaoiA. ell m\ad ir a'dillsidalheoiaheoahosihgpo[iajfehgi[aoerjhglahgarg[apiejlhfl[adjfjdalkfjadlkhga[hgaerlkhga[lfdjgalhetl[ajl;jegjalrefgao")
                    ],
                  ),
                )
              ],
